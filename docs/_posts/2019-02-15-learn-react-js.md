...
```tf
resource "aws_secretsmanager_secret" "dbtools" {
  name        = "db-tools"
  description = "Developer Tools Access for Querying"

  rotation_lambda_arn     = "arn:aws:lambda:eu-central-1:${var.staging_account_id}:function:${var.venture}-${var.environment}-rotate_multi_user_db_password"
